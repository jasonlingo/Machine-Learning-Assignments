...
// by Travis Wolfe
// November 17, 2011
// modified by Michael Paul
// November 28, 2012
// modified by Yiming Wang
// April 3, 2014
// modified by Yiming Wang
// November 7, 2014
...
public class LoopMRFPotentials {

	private double[][] potentials1;
	private double[][][] potentials2;
	private int n, k;

	public LoopMRFPotentials(String data_file) {
		int line_num = 1;
		try {
			...
			potentials2 = new double[2*n+1][k+1][k+1];
			for(int i=1; i<=n; i++) { 
				for(int a=1; a<=k; a++) { 
					potentials1[i][a] = -1.0;
				}
	...
	public int loopLength() { return n; }
